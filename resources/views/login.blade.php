...
<body class="min-h-screen bg-gray-100">
    ...
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        ...
        <div class="flex justify-center items-center bg-gray-100 p-4">
            <p class="text-gray-500 text-sm text-center">アカウントを忘れましたか？ <a href="#" class="text-indigo-500 hover:text-indigo-600 active:text-indigo-700 transition duration-100">新規作成</a></p>
        </div>
        </form>
    </div>
</div>
